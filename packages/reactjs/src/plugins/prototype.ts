...
import { Enumlocales } from './locales';
lodash.set(React, 'Dayjs', dayjs)
lodash.set(React, '$Enumlocales', Enumlocales)
lodash.set(React, 'DataFormat', (date, template = 'YYYY-MM-DD HH:mm:ss') => dayjs(date).format(template))
...
Object.defineProperty(React.Component.prototype, '$Enumlocales', {
...
declare module 'react' {
    ...
    /** 语言包 枚举 */
    const $Enumlocales: typeof Enumlocales;
